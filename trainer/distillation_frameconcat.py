    ...
    def fwdbwd_one_step(self, batch, train_generator):
        ...
        with torch.no_grad():
            ...
            if random.random() < 0.1:  # [TODO]
                ...
                shot_flags_for_rope = [0] * len(shot_flags_for_rope)  # [Note: Added 2026-01-09] Also set flag as zero
        ...
        if train_generator:
            ...
            # log_gpu_memory("Before train_generator backward pass", device=self.device, rank=dist.get_rank())
